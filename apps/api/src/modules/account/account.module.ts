 ...
 *
 * It exists because the erasure must sequence identity + ai + coaching + payments, and identity is
 ...
 */
@Module({
  imports: [IdentityModule, AiModule, CoachingModule, PaymentsModule],
