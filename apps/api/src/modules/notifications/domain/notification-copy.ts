...
export const NotificationCopyKey = {
  ...
  PLAN_EVENT_CREATED: "planEventCreated",
  PLAN_EVENT_UPDATED: "planEventUpdated",
  PLAN_EVENT_CANCELLED: "planEventCancelled",
  PLAN_EVENT_CREATED_ALL_DAY: "planEventCreatedAllDay",
  PLAN_EVENT_UPDATED_ALL_DAY: "planEventUpdatedAllDay",
  PLAN_EVENT_CANCELLED_ALL_DAY: "planEventCancelledAllDay",
  PLAN_EVENT_REMINDER: "planEventReminder",
