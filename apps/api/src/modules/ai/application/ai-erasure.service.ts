 ...
 *
 * Erased: coach threads (messages + suggested tasks cascade), the distilled memory profile, and the
 * cached weekly-review narrations — all of it is the user's own words or AI text about them.
