...
ALTER TABLE "plan_events" ADD CONSTRAINT "plan_events_series_id_plan_event_series_id_fk" FOREIGN KEY ("series_id") REFERENCES "public"."plan_event_series"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "plan_events_id_organizer_unique_idx" ON "plan_events" USING btree ("id","organizer_user_id");--> statement-breakpoint
