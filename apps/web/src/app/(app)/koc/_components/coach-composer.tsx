...
>(function CoachComposer({ value, onChange, onSend, busy }, ref) {
  ...
  return (
    ...
    >
      ...
      <p className="mx-auto mt-2 max-w-2xl text-xs" style={{ color: "var(--color-secondary)" }}>
        Koç resmî sınav tarihi/süreç bilgisi vermez — bunlar için Bilgi Merkezi’ne bak.
      </p>
    </div>
  );
});
