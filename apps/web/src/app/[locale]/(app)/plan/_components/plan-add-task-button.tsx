...
export function PlanAddTaskButton({
  ...
  return (
    <button
      ...
      className="group flex h-9 max-w-full flex-row-reverse items-center overflow-hidden rounded-[var(--radius-card)] border border-white/60 bg-white/70 transition-[background-color,border-color,box-shadow] duration-200 ease-out hover:border-white hover:bg-white/90 hover:shadow-[var(--shadow-card)] focus-visible:border-white focus-visible:bg-white/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:shadow-[var(--shadow-card)] disabled:cursor-not-allowed disabled:opacity-50 motion-reduce:transition-none motion-reduce:hover:shadow-none"
