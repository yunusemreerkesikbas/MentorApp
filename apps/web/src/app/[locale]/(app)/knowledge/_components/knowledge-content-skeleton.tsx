...
/** Inner blocks shared by Suspense fallback and in-place SkeletonReveal. */
export function KnowledgeSkeletonBlocks() {
  return (
...
/** Suspense fallback — full page chrome; no shared tree with the client shell. */
