 ...
 * (`/topluluk/uye/...` — the page already leads with an identity + stats header; on your own profile the
...
export function HideCompanion({ children }: { children: ReactNode }) {
  ...
  const hide = path === "/topluluk/siralama" || path.startsWith("/topluluk/uye/");
