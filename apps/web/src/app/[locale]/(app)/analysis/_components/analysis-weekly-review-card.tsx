...
interface AnalysisWeeklyReviewCardProps {
  review: WeeklyReviewDto;
}

export function AnalysisWeeklyReviewCard({
  review,
}: AnalysisWeeklyReviewCardProps) {
...
export function AnalysisWeeklyReviewSkeleton() {
  const t = useTranslations("analysis.weekly");
