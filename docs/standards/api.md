...
|---|---|---|---|---|
| `identity` | `/v1/auth/{signup,login,refresh,logout,verify-email,forgot-password,reset-password}`, `/v1/users/me`, `/v1/users/me/verification-email`, `/v1/users/me/avatar-upload-url` | own JWT + refresh rotation (httpOnly cookie), roles, org-ready, RLS, profile avatar upload | MVP | ✅ |
