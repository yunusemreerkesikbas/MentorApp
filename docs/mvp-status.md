...
| **W3 AI** | 🟡 | premium AI coach chat ([0030](./devnotes/0030-w3-ai-coach-chat-slice1.md)) + **web koç UI** (`/koc`, ephemeral transcript, premium gate) ([0031](./devnotes/0031-w3-web-koc-ui.md), UI polish [0034](./devnotes/0034-w3-web-koc-ui-polish.md)) · **RAG grounding + source links** ([0043](./devnotes/0043-w3-ai-rag-grounding.md)) | multi-turn/streaming, photo→categorize, **coin→AI-right spend**, Gemini |
