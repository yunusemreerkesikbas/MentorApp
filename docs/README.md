...
- [conventions.md](./conventions.md) — code/commit/PR/language/config conventions
...
## Development log
- [devnotes/](./devnotes/README.md) — a short usage/tutorial note after every development (mandatory)
